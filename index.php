...
<head>
  ...
  <link rel="shortcut icon" href="dist/assets/images/logo-icon.png" />
          ...
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section">
                <div class="main-blue-button"><a href="#">Get Your Quote</a></div>
              </li>
            </ul>
                      ...
                      <div class="card-body">
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                              <?= mysqli_num_rows(mysqli_query($koneksi, "select * from daftar where jenkel = 'L' && status = '1'")) ?>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card-body">
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                              <?= mysqli_num_rows(mysqli_query($koneksi, "select * from daftar where jenkel = 'P' && status = '1'")) ?>
                            </div>
                          </div>
                        </div>
                      </div>
