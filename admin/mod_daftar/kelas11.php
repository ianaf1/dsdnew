...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h5 class="m-0 font-weight-bold text-primary">Siswa Kelas 11</h5>
            <div class="card-header-action">
                <a class="btn btn-primary btn-sm" href="mod_daftar/export/export_excel11.php" role="button"><i class="fas fa-download"></i> Download Excel</a>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table style="font-size: 14px" class="table table-bordered table-sm" id="dataTable">
                    ...
                    <tbody>
                        <?php
                        $query = mysqli_query($koneksi, "select * from daftar where status='1' && kelas='11'");
                        $no = 0;
