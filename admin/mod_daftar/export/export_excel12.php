...
header("Content-Disposition: attachment; filename=DATA_SISWA_Kelas_12.xls");
session_start();
...
<table border="1">
    ...
    <tbody>
        <?php
        $query = mysqli_query($koneksi, "select * from daftar where status = '1' && kelas = '12' order by nama asc");
        $no = 0;
