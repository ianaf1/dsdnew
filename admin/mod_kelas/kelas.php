                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button data-id="<?= $kelas['id_kelas'] ?>" class="hapus btn btn-danger btn-sm">Hapus</button>
                                                    ...
                                                    <form id="form-edit<?= $no ?>">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="kode_kelas" value="<?= $kelas['kode_kelas'] ?>" class="form-control" required="">
                                                            </div>
                                                            <div class="form-group">
