                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $rombel['nis'] ?></td>
                                        <td><?= $rombel['nama'] ?></td>
                                        <td><?= mysqli_num_rows(mysqli_query($koneksi, "select * from presensi where nis='$rombel[nis]' AND ket='Hadir' AND bulan='$bulan'")) ?> </td>
                                        <td><?= mysqli_num_rows(mysqli_query($koneksi, "select * from presensi where nis='$rombel[nis]' AND ket='Bolos' AND bulan='$bulan'")) ?> </td>
                                    </tr>
                                <?php }
                                ?>
                            </tbody>
