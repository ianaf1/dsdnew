...
$pekerjaan = array("Tidak Bekerja", "Pensiunan", "PNS", "TNI/Polisi", "Guru/Dosen", "Pegawai Swasta", "Wiraswasta", "Pengacara/Jaksa/Hakim/Notaris", "Seniman/Pelukis/Artis/Sejenis", "Dokter/Bidan/Perawat", "Pilot/Pramugara", "Pedagang", "Petani/Peternak", "Nelayan", "Buruh (Tani/Pabrik/Bangunan)", "Sopir/Masinis/Kondektur", "Politikus", "Lainnya");
$penghasilan = array("Kurang dari 500.000", "500.000 - 1.000.000", "1.000.001 - 2.000.000", "2.000.001 - 3.000.000", "3.000.001 - 5.000.000", "Lebih dari 5.000.000", "Tidak Ada");
$pendidikan = array("SD/Sederajat", "SMP/Sederajat", "SMA/Sederajat", "D1", "D2", "D3", "D4/S1", "S2", "S3");
$transport = array("Jalan Kaki", "Sepeda", "Sepeda Motor", "Mobil Pribadi", "Antar Jemput Sekolah", "Angkutan Umum", "Perahu/Sampan", "Lainnya");
$jarak = array("Kurang dari 5 km", "Antara 5-10 km", "Antara 10-20 km", "Antara 21-30 km", "Lebih dari 30 km");
$cita = array("PNS", "TNI/POLRI", "Guru/Dosen", "Dokter", "Politikus", "Wiraswasta", "Seniman/Artis", "Ilmuwan", "Agamawan", "Lainnya");
$hobi = array("Olahraga", "Kesenian", "Membaca", "Menulis", "Jalan-jalan", "Lainnya");
$status = array("Masih Hidup", "Sudah Meninggal", "Tidak Diketahui");
$waktu = array("1-10 menit", "10-19 menit", "20-29 menit", "30-39 menit", "1-2 jam", "Lebi dari 2 Jam");
$tk = array("Ya", "Tidak");
$paud = array("Ya", "Tidak");
$imun = array("Ya", "Tidak");
$jenistinggal = array("Bersama Orang Tua", "Ikut Saudara/Kerabat", "Asrama Madrasah", "Kontrak/Kost", "Asrama Pesantren", "Panti Asuhan", "Rumah Singgah", "Lainnya");
$jeniskelamin = ["L" => "Laki-laki", "P" => "Perempuan"];
$kepegawaian = ["1" => "PNS", "2" => "Non PNS"];
$inpassing = ["0" => "Belum Inpassing", "1" => "Sudah Inpassing"];
$instansipengangkat = ["1" => "Kementrian Agama", "2" => "Yayasan Penyelenggara"];
$tempattugas = ["1" => "Satminkal", "2" => "Bukan Satminkal"];
